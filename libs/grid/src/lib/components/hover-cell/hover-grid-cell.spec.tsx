...
describe('#HoverGridCell', () => {
    ...
    const defaultClassName = '.GridCell-defaultCell';
    const defaultHoverClassName = '.GridCell-hoverCell';
    ...
    describe('cell style', () => {
        ...
        it('should render with vertical line when cell should display vertical line', () => {
            // given
            const className = 'GridCell-defaultCell GridCell-verticalLine';
            container = shallow(
        ...
        it('should render with horizontal line style when cell should display horizontal line', () => {
            // given
            const className = 'GridCell-defaultCell GridCell-horizontalLine';
            container = shallow(
        ...
        it('should render with horizontal and vertical line style when cell should display both lines', () => {
            // given
            const className = 'GridCell-defaultCell GridCell-horizontalLine GridCell-verticalLine';
            container = shallow(
