...
import { fromString, fromStringDirect, MultiplicationType, OperationType } from '@calc/calc-arithmetic';
...
const getCalculatorGrid: () => HoverOperationGrid = () => {
    const params: OperationParams = {
        ...
        operands: [fromStringDirect("FD", 16).result, fromStringDirect("-7", 16).result],
        base: 16
    };
...
const getBaseConverterGrid: () => HoverOperationGrid = () => {
    const conversion = fromString('64', 10, 2);
